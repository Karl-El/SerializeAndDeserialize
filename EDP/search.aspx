                        ...
                        <div class=" row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p>
                                    ...
                                    <asp:Label CssClass="form-control-label" ID="lbl_StockDesc" runat="server" Text="Label" Font-Size="Small" ForeColor="#009900">In stock. Usually ships next business day.</asp:Label></p>
                                <p>
                                    <label style="font-size: small">Manufacturer:</label>
                                    <asp:Label CssClass="form-control-label" ID="lbl_Manufact" runat="server" Text="Label" Font-Size="Small">Dell</asp:Label></p>
                            </div>
                            <div class="col-sm-3">
                                <br />
                                <br />
