...
namespace WebServiceDeserialization
{
    public class EDPList
    {
        public List<string> ListingEDP()
        {
            ...
            XmlTextReader reader = new XmlTextReader("http://afs-sl-schmgr03.afservice.org:8080/searchManager/search/afs-sl-schmstr.afservice.org:8080/solr4/Products/select?q=laptop&fl=EDP&store=pcmall&rows=250&start=0");
